...
- 2026-09-04: Shadow-mind self-evolution should support direct updates to global AGENTS.md, project AGENTS.md, existing/new SKILL.md files, durable memory, and sibling Evolution.md logs. Evidence: user clarified the desired model during design discussion. Applied: global self-evolution skill and evolution shadow created outside the package source.
- 2026-09-04: Avoid generated regions inside AGENTS.md/SKILL.md; keep evolution evidence in sibling logs and keep stable rule files clean. Evidence: user explicitly rejected marker-based generated blocks. Applied: use standalone `Evolution.md` files.
